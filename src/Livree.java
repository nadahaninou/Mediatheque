 ...
 * @author DELL
 */
public class Livree extends javax.swing.JFrame {

    /**
     * Creates new form Livree
     */
public Livree() {
    initComponents();
    ...
    private void initComponents() {
        ...
        choixgestionlivre = new javax.swing.ButtonGroup();
        ...
        gestionLivre.setText("Gestion des Livres");
        ...
        choix.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Ajouter Livre", "Supprimer Livre", "Rechercher Livre", "Afficher tous livres", " " }));
        ...
        combchoix.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "nbPages", "langue", "ISBN", "titre", "Editeur", "anneeEdition", "URL", "favorie", "recommande", " " }));
        ...
        tableLivre.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "nbPages", "langue", "ISBN", "titre", "Editeur ", "anneeEdition", "URL", "favorie", "recommande", "Auteur1", "Auteur2", "Auteur3", "Auteur4", "Auteur5"
            }
        ));
...
switch(choix.getSelectedItem().toString()){
        ...
        case "Afficher tous livres":{
            tableLivre.setVisible(true);
               ...
               rech.setVisible(false);
                ...
                GestionLivre gest = new GestionLivre();
    LinkedList<Livre> livres = new LinkedList<>();
    try {
        livres = gest.afficherTousLesLivres();
    ...
    isbn.setText("");
    GestionLivre gest = new GestionLivre();
    LinkedList<Livre> livres = new LinkedList<>(); // Initialize livres as an empty list

    switch (combchoix.getSelectedItem().toString()) {
        case "nbPages":
            try {
                livres = gest.getLivresByNbPages(Integer.parseInt(a));
            } catch (SQLException ex) {
                Logger.getLogger(Livree.class.getName()).log(Level.SEVERE, null, ex);
            }
            break;
        case "langue": 
            try {
                livres = gest.getLivresByLangue(a);
            } catch (SQLException ex) {
                Logger.getLogger(Livree.class.getName()).log(Level.SEVERE, null, ex);
            }
            break;
        ...
        case "titre":
            try {
                livres = gest.getLivresByTitre(a);
            } catch (SQLException ex) {
                Logger.getLogger(Livree.class.getName()).log(Level.SEVERE, null, ex);
            }
            break;
        case "Editeur": 
            try {
                livres = gest.getLivresByEditeur(a);
            } catch (SQLException ex) {
                Logger.getLogger(Livree.class.getName()).log(Level.SEVERE, null, ex);
            }
            break;
         case "anneeEdition": 
             try {
                livres = gest.getLivresByAnneeEdition(Integer.parseInt(a));
            } catch (SQLException ex) {
                Logger.getLogger(Livree.class.getName()).log(Level.SEVERE, null, ex);
            }
            break;
         ...
         case "favorie": 
             try {
                livres = gest.getLivresByFavorie(Integer.parseInt(a));
            } catch (SQLException ex) {
                Logger.getLogger(Livree.class.getName()).log(Level.SEVERE, null, ex);
            }
            break;
        case "recommande": 
            try {
                livres = gest.getLivresByRecommande(Integer.parseInt(a));
            } catch (SQLException ex) {
                Logger.getLogger(Livree.class.getName()).log(Level.SEVERE, null, ex);
            }
            break;
    ...
    private void suppActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_suppActionPerformed
        ...
        try {
            boolean a=gest.supprimerLivre(isbne);
        } catch (SQLException ex) {
            Logger.getLogger(Livree.class.getName()).log(Level.SEVERE, null, ex);
        }
        isbn.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Livree.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.ButtonGroup choixgestionlivre;
