 ...
 * @author DELL
 */
public class AddRoman extends javax.swing.JFrame {

    /**
     * Creates new form AddRoman
     */
    public AddRoman() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        nbPages.setText("genre:");

        jLabel2.setText("auteur2");

        langue.setText("nbChapitres:");
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(57, 57, 57)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(case3, javax.swing.GroupLayout.PREFERRED_SIZE, 271, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void AddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddActionPerformed
        String genre=case1.getText();
        String nbChapitres=case2.getText();
        ...
        GestionRoman a=new GestionRoman();
        Roman livre =new Roman(genre,Integer.parseInt(nbChapitres),isbn,titre,editeur,Integer.parseInt(anneeedition),url,Integer.parseInt(favorie),Integer.parseInt(recommande),auteur1,auteur2,auteur3,auteur4,auteur5);
        try {
            boolean b=a.ajouterRoman(livre);
        } catch (SQLException ex) {
            Logger.getLogger(AddRoman.class.getName()).log(Level.SEVERE, null, ex);
        }
        case1.setText("");
        case2.setText("");
        case3.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddRoman.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
